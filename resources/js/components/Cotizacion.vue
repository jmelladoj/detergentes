        ...
        <div class="container-fluid">
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        ...
                        <button type="button" v-b-tooltip.hover title="Agregar cotizaciones al sistema" @click="abrirModal('cotizacion','registrar')" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Crear Cotizacion</button>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <div v-show="estadoCotizacion" class="form-group row alert alert-success">
                                <div class="text-left">
                                    ...
                                    <div class="table-responsive">
                                        <b-container fluid>
                                            ...
                                            <template slot="acciones" slot-scope="row">
                                                ...
                                                <b-button size="xs" v-b-tooltip.hover title="Descargar cotización como pdf" @click="descargar(row.item.id)" class="btn btn-warning">
                                                    <i class="fa fa-file-pdf-o"></i>
                                                </b-button>

                                                <b-button size="xs" v-b-tooltip.hover title="Enviar cotización al cliente" @click="enviar(row.item.id)" class="btn btn-success">
                                                    <i class="fa fa-envelope"></i>
                                                </b-button>

                                                <b-button v-if="row.item.deleted_at" size="xs" v-b-tooltip.hover title="Restaurar Cotización" @click="resturar(row.item.id)" class="btn btn-warning">
                                                    <i class="fa fa-undo"></i>
                                                </b-button>

                                                <b-button v-else size="xs" v-b-tooltip.hover title="Anular Cotización" @click="anular(row.item.id)"  class="btn btn-danger">
    ...
    export default {
        ...
        methods : {
            ...
            descargar(id){
               swal({
                ...
                if (result.value) {
                    ...
                    axios.get('/documento/cotizacion/'+id+'/descargar', {responseType: 'blob'}).then(function (response) {                       
                        const url = window.URL.createObjectURL(new Blob([response.data]));
                        const link = document.createElement('a');
                        link.href = url;
                        link.setAttribute('download', 'Cotización.pdf'); //or any other extension
            ...
            enviar(id){
               swal({
                ...
                if (result.value) {
                    ...
                    axios.get('/documento/cotizacion/'+id+'/enviar').then(function (response) {
                        me.listarCotizaciones();
                        swal(
                        'Documento enviado!',
            ...
            validarCotizacion(){
                ...
                if (!this.rut) this.errores.push("El rut de empresa en la cotizacion no puede estar vacío.");
                if (!this.nombre) this.errores.push("El nombre de la empresa en lacotizacion no puede estar vacío.");
                if (!this.direccion) this.errores.push("La dirección de la empresa en la cotizacion no puede estar vacío.");
                if (!this.giro) this.errores.push("El giro de la empresa en lac otizacion no puede estar vacío.");
                if (this.telefono < 1) this.errores.push("El teléfono de la empresa en la cotizacion no puede estar vacío.");
                if (!this.comuna) this.errores.push("La comuna de la empresa en la cotizacion no puede estar vacío.");
            ...
            statusCotizacion(estado){
                ...
                if (this.estados.length) this.estadoCotizacion = 1;
